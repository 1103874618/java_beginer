...
public class Show_bit {
		  int numbit;  //储存转化后的bit值
		  ...
		  void show(long val){
			    long mask = 1;
			    mask <<= numbit-1;
			  	System.out.println("mask初始化值:"+mask);
			    //先减一后移位,再自赋值,表示将mask的值左移几位,八位就左移7位,因为自己占一位,最后移位得到的是8个1
...
class Show_bit_demo{
	...
	public static void main(String[] args){//java 对变量的修改只能放在方法中!!!
